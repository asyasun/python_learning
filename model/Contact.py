...
class Contact:
    ...
    def __init__(self, name=None, sec_name=None, last_name=None, nickname=None, company=None, phone=None, mobile=None,
                 work_phone=None, secondary_phone=None, all_phones_from_homepage=None, email=None, birth_day=None,
                 birth_month=None, birth_year=None, contact_id=None):
        self.name = name
    ...
    def __repr__(self):
        return "%s:%s, %s" % (self.contact_id, self.last_name, self.name)
